...
# from ..samplers.distributed_sampler import ClassSpecificDistributedSampler, DistributedSampler
...
def build_dataloader(dataset,
    ...
    Args:
        ...
        pin_memory (bool): Whether to use pin_memory in DataLoader.
            Default: True
        persistent_workers (bool): If True, the data loader will not shut down
