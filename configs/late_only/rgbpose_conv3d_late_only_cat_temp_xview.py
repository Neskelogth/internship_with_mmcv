...
data = dict(
    ...
    train=dict(type=dataset_type, ann_file=ann_file, split='xview_train', data_prefix=data_root, pipeline=train_pipeline),
...
work_dir = './work_dirs/late_only/late_only_cat_temp/hrnet/xview'
